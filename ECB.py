...
class ECB(nn.Module):
    def __init__(self, inp_planes, out_planes, depth_multiplier, act_type='prelu', with_idt=False, flag = 1):
    ...
    def forward(self, x):
        if self.training:
            ...
            y = F.conv2d(input=x, weight=self.RK, bias=self.RB, stride=1, padding=1)
